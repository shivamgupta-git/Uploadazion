 ...
 *
 */
declare const createDomainWrapper: (domain: AzionCreateDomain, options?: AzionClientOptions) => Promise<AzionDomainsResponse<AzionDomain>>;
/**
 * List domains
 ...
 * }
 */
declare const getDomainsWrapper: (options?: AzionClientOptions, queryParams?: {
    orderBy?: "id" | "name";
    page?: number;
    pageSize?: number;
    sort?: "asc" | "desc";
 ...
 *
 */
declare const getDomainWrapper: (domainId: number, options?: AzionClientOptions) => Promise<AzionDomainsResponse<AzionDomain>>;
/**
 * Update a domain
 * @param domainId Domain ID
 ...
 * }
 */
declare const updateDomainWrapper: (domainId: number, domain: AzionUpdateDomain, options?: AzionClientOptions) => Promise<AzionDomainsResponse<AzionDomain>>;
/**
 * Delete a domain
 * @param domainId Domain ID
 ...
 *
 */
declare const deleteDomainWrapper: (domainId: number, options?: AzionClientOptions) => Promise<AzionDomainsResponse<AzionDeletedDomain>>;
/**
...
export { type AzionClientOptions, type AzionCreateDomain, type AzionDeletedDomain, type AzionDomain, type AzionDomainCollection, type AzionDomainsClient, type AzionDomainsCreateClient, type AzionDomainsResponse, type AzionUpdateDomain, type ResponseState, createClient, createDomainWrapper as createDomain, createClient as default, deleteDomainWrapper as deleteDomain, getDomainWrapper as getDomain, getDomainsWrapper as getDomains, updateDomainWrapper as updateDomain };
